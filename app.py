...
def get_conversational_chain():
    ...
    model = ChatGoogleGenerativeAI(
        model="models/gemini-flash-latest",  # <-- use a model listed from list_models()
...
def user_input(user_question):
    try:
        embeddings =  HuggingFaceEmbeddings(
            model="sentence-transformers/all-MiniLM-L6-v2")  # type: ignore
...
def main():
    ...
    st.title("AI Document Q&A Assistant using RAG 🤖")
